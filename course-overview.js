...
var courseOverviewData = [
  ...
  },
  {
    ...
    "source": {
      "exists": true,
      "folder": "ai-assisted-coding-fundamentals/deploy/content",
      "modules": 2
    },
    "coverage": 60,
...
var courseOverviewMap = {};
courseOverviewData.forEach(function(c) {
  courseOverviewMap[c.id] = c;
  courseOverviewMap[c.name] = c;
});
