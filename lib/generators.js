 ...
 *
 * Reads course-overview.json (generated by generate-course-overview.py)
 * and wraps it as a JS bundle with two globals:
 *   const courseOverviewData = [...];   // array of overview objects
 *   const courseOverviewMap = {};       // id → overview object
 */
