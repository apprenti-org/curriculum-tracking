...
const courseData = [
  ...
  },
  {
    ...
    "name": "AI Code Auditing for Security (Cyber Developer Associate)",
    "hours": 40,
    "status": {
      "design": "Complete",
      "development": "Complete"
    },
    "syllabus": "Syllabus: AI Code Auditing for Security",
    "outline": true,
    "note": "Cyber Developer Associate net-new 40h Phase 7 course. 5 modules, 16 lessons (no capstone lesson; L16 is a standard integrative audit lab). Primary owner of OJL 1.d at full depth: auditing AI-generated code for hallucinations and security flaws — audit mindset, hallucination/slopsquatting detection, configuration + Dependency Injection auditing (A-31 exemplar), vulnerability-class confirmation, remediation, and the pre-deployment gate. Code-bearing: 16 paired audit-target projects (Python M1-2, Java/Spring M3-5). Design+outline (#1089) + lesson outlines (#1091) + lesson sources (#1093) + scaffolding (#1095) + code migration (#1097) + content/interactives 96/96 check.js (Row 7, #1099) + slides deferred (#1100, per #606) + SCORM 16 zips (Row 9, #1101) + deployment 3 private repos (Row 10, #1103) + instructor/pacing guide (Row 11, #1105) + starter asset audit (Row 12, #1106) complete. Pre-upload (Row 13); LMS upload (Row 14) pending. Onboarding meta #1088.",
    "driveFolder": null,
    "statusConfirmed": true,
  ...
  },
  {
    ...
    "name": "AI-Assisted Assessment Prep (Cyber Developer Associate)",
    "hours": 10,
    "status": {
      "design": "Complete",
      "development": "Complete"
  ...
  },
  {
    ...
    "syllabus": "syllabi/ai-assisted-it-service-management.html",
    "outline": true,
  ...
  },
  {
    ...
    "syllabus": "syllabi/ai-assisted-threat-analysis-and-defense.html",
    "outline": true,
  ...
  {
    "id": "docker-container-isolation",
    "name": "Docker Container Isolation (Cyber Developer Associate)",
    "hours": 16,
    "status": {
      "design": "Complete",
      "development": "Complete"
    },
    "syllabus": "syllabi/docker-container-isolation.html",
    "outline": true,
  ...
  {
    "id": "introduction-to-html-and-css-secure",
    "name": "Introduction to HTML & CSS — Secure (Cyber Developer Associate)",
    "hours": 40,
    "status": {
      "design": "Complete",
      "development": "Complete"
  ...
  },
  {
    ...
    "syllabus": null,
    "outline": true,
    "note": "Live course — 4 modules, 12 lessons, 16h. Content + 12 interactive lessons + 12 SCORM produced; deployed (deploy/content: 100 PDFs + 12 SCORM; deploy/html mirror). Instructor-guide repo + pacing guide (itil-specialist-4-instructor, row 11); sample-service starter asset provisioned (itil-specialist-4-sample-service, row 12). Pre-upload reconciliation complete (row 13).",
    "driveFolder": null,
    "statusConfirmed": true
  },
  {
  ...
  },
  {
    ...
    "syllabus": null,
    "outline": true,
    "note": "Cyber Developer Associate net-new 10h Phase 5 course. 2 modules, 9 lessons (L9 course-level capstone lab): What MCP Is & the Trust Model; MCP Primitives (tools/resources/prompts); Building Your First Secure Server (Python SDK, stdio); Exposing Data with Least Privilege; Preventing Database Exposure; Validating Inputs & Sanitizing Data; Authentication & Authorization; Secure Error Handling & Logging; Capstone Lab — Shielded Transaction Context. Security-by-construction; official Python MCP SDK; running example exposes transaction context to an LLM with the database shielded. Built, deployed (content repo apprenti-org/mcp-servers-content; instructor package apprenti-org/mcp-servers-instructor; student starter apprenti-org/mcp-servers-student), and live in Absorb 2026-06-17. OJL 1.c. Onboarding meta apprenti-org/design-documentation#957.",
    "driveFolder": null,
    "statusConfirmed": true,
    "sourceRepo": "https://github.com/apprenti-org/design-documentation"
  },
  ...
  {
    "id": "transaction-validation-service-capstone",
    "name": "Transaction Validation Service Capstone (Cyber Developer Associate)",
    "hours": 40,
    "status": {
      "design": "Complete",
      "development": "Complete"
